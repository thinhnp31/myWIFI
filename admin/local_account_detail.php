...
<?php 
    ...
    if (isset($_GET['submit'])) {
      ...
      if ($password ==  "") {
        $stmt = $conn->prepare("UPDATE users SET fullname = ?, username = ?, expiry_date = ?, device_limit = ? WHERE user_id = ?");
        $stmt->bind_param('sssii', $fullname, $username, $expiry_date, $device_limit, $user_id);
        $stmt->execute();
        $msg = "Cập nhật thành công";
        $type= "success";
      } else {
        $stmt = $conn->prepare("UPDATE users SET fullname = ?, username = ?, password = ?, expiry_date = ?, device_limit = ? WHERE user_id = ?");
        $stmt->bind_param('ssssii', $fullname, $username, $password, $expiry_date, $device_limit, $user_id);
        $stmt->execute();
        $msg = "Cập nhật thành công";
        $type= "success";
      }
      ...
      <div class="row no-gutters g-pos-rel g-overflow-x-hidden">
          ...
          <div class="col g-ml-45 g-ml-0--lg g-pb-65--md">
            ...
            <div class="g-pa-20">
              ...
              ?> 
              <h1 class="g-font-weight-300 g-font-size-28 g-color-black g-mb-30">Chi tiết tài khoản: </h1>
              <!-- Form -->
                    <form class="g-py-15" method="GET" action="#" onsubmit="return form_validate()">
                      <div class="mb-4">
                        ...
                        <input class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--hover rounded g-py-15 g-px-15" name="fullname" value="<?php echo $fullname; ?>" required>
                      </div>

                      <div class="mb-4">
                        <label class="g-color-gray-dark-v2 g-font-weight-600 g-font-size-13">Tên đăng nhập:</label>
                        <input class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--hover rounded g-py-15 g-px-15" type="text" name="username" value="<?php echo $username; ?>"required>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-xs-12 col-sm-6 mb-4 form-group" id = "password_holder">
                            ...
                            <input class="form-control form-control-md g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--hover rounded g-py-15 g-px-15" type="password"name="password" id="password">
                        </div>
                      ...
                      <div class="row">
                        <div class="col-xs-12 col-sm-6 mb-4 form-group" >
                            ...
                            <input class="form-control form-control-md g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--hover rounded g-py-15 g-px-15" type="date"  name="expiry_date" value="<?php echo $expiry_date; ?>" required="">
                        </div>

                        <div class="col-xs-12 col-sm-6 mb-4 form-group" >
                          <label class="g-color-gray-dark-v2 g-font-weight-600 g-font-size-13">Số thiết bị tối đa:</label>
                          <input class="form-control form-control-md g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--hover rounded g-py-15 g-px-15" type="text" name="device_limit" value=<?php echo $device_limit; ?>>
                          <small class = "form-control-feedback">0: Không giới hạn</small>
                        </div>
                      </div>
                      <input type="hidden" name="user_id" value=<?php echo $user_id;?>>
                      <div class="mb-4 text-center">
                        <input type="submit" class="btn btn-md u-btn-secondary rounded g-py-13 g-px-50" name="submit" value="Cập nhật">
                      </div>
                    </form>
                    <!-- End Form -->
            </div>
