    ...
    if (isset($_SESSION['email'])) { //if this client still has a session
      ...
      // Check duplicate name
          ...
          if ($result->num_rows > 0) {
            $msg = "Tên thiết bị đã tồn tại<br>";
            $addOK = 0;
          } 
      // Check duplicate SN
          ...
          $result = $stmt->get_result();
          if ($result->num_rows > 0) {
            $msg = "Serial Number đã tồn tại<br>";
            $addOK = 0;
          }
           ...
           <div class="row no-gutters g-pos-rel g-overflow-x-hidden">
            ...
            <div class="col g-ml-45 g-ml-0--lg g-pb-65--md">
             ...
             <div class="g-pa-20">
              ...
              ?> 
              <h1 class="g-font-weight-300 g-font-size-28 g-color-black g-mb-30">Thêm thiết bị</h1>
              <!-- Form -->
              <form class="g-py-15" method="GET" action="#" onsubmit="return form_validate()">
                <div class="mb-4">
                  ...
                  <input class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--hover rounded g-py-15 g-px-15" name="gw_name" required>
                </div>
                ...
                <div class="row">
                  <div class="col-xs-12 col-sm-6 mb-4 form-group" id = "password_holder">
                    ...
                    <input class="form-control form-control-md g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--hover rounded g-py-15 g-px-15" type="text" name="gw_sn" required>
                  </div>
