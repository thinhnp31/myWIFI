...
<?php 
    ...
    $stmt = $conn->prepare("SELECT COUNT(connection_id) AS total FROM `connections`;");
    $stmt->execute();
    $result = $stmt->get_result();
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $temp_labels = $row['date'];
        array_push($connection_series, $temp_series);
        array_push($connection_labels, $temp_labels);
    }

    //Get number of clients    
    $stmt = $conn->prepare("SELECT DISTINCT mac FROM `connections`");
    $stmt->execute();
    $result = $stmt->get_result();
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $temp_labels = $row['date'];
        array_push($client_series, $temp_series);
        array_push($client_labels, $temp_labels);
    }
    ...
    //Get top device 
    $stmt = $conn->prepare("SELECT device, COUNT(device) AS count FROM connections GROUP BY device ORDER BY count DESC");
    $stmt->execute();
    $result = $stmt->get_result();
    $row = $result->fetch_assoc();
...
<head>
  <!-- Title -->
  <title>Dashboard v.2 | MyWIFI</title>
  ...
  <main class="container-fluid px-0 g-pt-65">    
    <div class="row no-gutters g-pos-rel g-overflow-x-hidden">
      ...
      <i class="hs-admin-angle-right"></i>
          ...
          <i class="hs-admin-infinite"></i>
              ...
              <!-- Dashboards v2 -->
              <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12 active" href="../dashboards/dashboard-v2.php">
                  <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
          <i class="hs-admin-blackboard"></i>
              ...
              <!-- Dashboards v3 -->
              <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="../dashboards/dashboard-v3.php">
                  <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
    ...
    End Panel Options -->
      ...
      <div class="col g-ml-45 g-ml-0--lg g-pb-65--md">
        <div class="g-pa-20">
          <h1>Thống kê tháng <?php echo $current_month; ?></h1>
          <div class="row">
            <div class="col-sm-6 col-lg-6 col-xl-3 g-mb-30">
              ...
              <div class="card h-100 g-brd-gray-light-v7 rounded">
                <div class="card-block g-pa-20">
                  ...
                  <span class="d-flex align-self-center g-font-weight-400 g-color-gray-dark-v6">Tổng số kết nối</span>
                  ...
                  <div class="d-flex align-items-center">
                    <span class="g-font-weight-300 g-font-size-24 g-color-black"><?php echo $total_connections; ?></span>
                  </div>
                </div>

                <div class="js-area-chart u-area-chart--v1 g-pos-rel g-line-height-0" data-height="72px" data-high="<?php echo $max_connections; ?>" data-low="0" data-offset-x="0" data-offset-y="0" data-postfix=" m" data-is-show-area="true" data-is-show-line="true" data-is-show-point="true" data-is-full-width="true"
            ...
            <div class="col-sm-6 col-lg-6 col-xl-3 g-mb-30">
              ...
              <div class="card h-100 g-brd-gray-light-v7 rounded">
                <div class="card-block g-pa-20">
                  <h4 class="media g-font-size-16 g-mb-10">
                  <span class="d-flex align-self-center g-font-weight-400 g-color-gray-dark-v6">Tổng số người dùng</span>
                  ...
                  <div class="d-flex align-items-center">
                    <span class="g-font-weight-300 g-font-size-24 g-color-black"><?php echo $total_clients;?></span>
                  </div>
                </div>

                <div class="js-area-chart u-area-chart--v1 g-pos-rel g-line-height-0" data-height="72px" data-high="<?php echo $max_clients; ?>" data-low="0" data-offset-x="0" data-offset-y="0" data-postfix=" m" data-is-show-area="true" data-is-show-line="true" data-is-show-point="true" data-is-full-width="true"
                data-is-stack-bars="true" data-is-show-axis-x="false" data-is-show-axis-y="false" data-is-show-tooltips="true" data-tooltip-description-position="left" data-tooltip-custom-class="u-tooltip--v2 g-font-weight-300 g-font-size-default g-color-gray-dark-v6"
            ...
            <div class="col-sm-6 col-lg-6 col-xl-3 g-mb-30">
              ...
              <div class="card h-100 g-brd-gray-light-v7 rounded">
                <div class="card-block g-pa-20">
                  <h4 class="media g-font-size-16 g-mb-10">
                  <span class="d-flex align-self-center g-font-weight-400 g-color-gray-dark-v6">Top Hệ điều hành</span>
                  ...
                  <div class="d-flex align-items-center">
                    <span class="g-font-weight-300 g-font-size-24 g-color-black"><?php echo $top_os . "<br>" . $number_top_os; ?></span>
                  </div>
                </div>                
              </div>
              <!-- End Panel -->
            ...
            <div class="col-sm-6 col-lg-6 col-xl-3 g-mb-30">
              ...
              <div class="card h-100 g-brd-gray-light-v7 rounded">
                <div class="card-block g-pa-20">
                  <h4 class="media g-font-size-16 g-mb-10">
                  <span class="d-flex align-self-center g-font-weight-400 g-color-gray-dark-v6">Top Thiết bị</span>
                  ...
                  <div class="d-flex align-items-center">
                    <span class="g-font-weight-300 g-font-size-24 g-color-black"><?php echo $top_device . "<br>" . $number_top_device; ?></span>
                  </div>
                </div>                
              </div>
              <!-- End Panel -->
            ...
            <div class="col-sm-6 col-lg-6 col-xl-3 g-mb-30">
              ...
              <div class="card h-100 g-brd-gray-light-v7 rounded">
                <div class="card-block g-pa-20">
                  <h4 class="media g-font-size-16 g-mb-10">
                  <span class="d-flex align-self-center g-font-weight-400 g-color-gray-dark-v6">Ngày nhiều kết nối nhất</span>
                  ...
                  <div class="d-flex align-items-center">
                    <span class="g-font-weight-300 g-font-size-24 g-color-black"><?php echo date("d-m-Y", strtotime($top_connection_day)) . "<br>Số lượng : " . $number_top_connection_day; ?></span>
                  </div>
                </div>
            ...
            <div class="col-sm-6 col-lg-6 col-xl-3 g-mb-30">
              ...
              <div class="card h-100 g-brd-gray-light-v7 rounded">
                <div class="card-block g-pa-20">
                  <h4 class="media g-font-size-16 g-mb-10">
                  <span class="d-flex align-self-center g-font-weight-400 g-color-gray-dark-v6">Giờ nhiều kết nối nhất</span>
                  ...
                  <div class="d-flex align-items-center">
                    <span class="g-font-weight-300 g-font-size-24 g-color-black"><?php echo $max_hour . ":00"; ?></span>
                  </div>
                </div>

                <div class="js-area-chart u-area-chart--v1 g-pos-rel g-line-height-0" data-height="72px" data-high="<?php echo $max_connection_hour; ?>" data-low="0" data-offset-x="0" data-offset-y="0" data-postfix=" m" data-is-show-area="true" data-is-show-line="true" data-is-show-point="true" data-is-full-width="true"
                data-is-stack-bars="true" data-is-show-axis-x="false" data-is-show-axis-y="false" data-is-show-tooltips="true" data-tooltip-description-position="left" data-tooltip-custom-class="u-tooltip--v2 g-font-weight-300 g-font-size-default g-color-gray-dark-v6"
                data-align-text-axis-x="center" data-fill-opacity=".1" data-fill-colors='["#15d3b2"]' data-stroke-width="2px" data-stroke-color="#15d3b2" data-stroke-dash-array="0" data-text-size-x="14px" data-text-color-x="#000000" data-text-offset-top-x="0"
                data-text-size-y="14px" data-text-color-y="#53585e" data-points-colors='["#15d3b2"]' data-series='[
                    [
                    <?php
                        $temp_string = '';                        
                        foreach($connection_hour_series as $value)
                            $temp_string .= '{"meta": "", "value": ' . $value .'},';
                        echo chop($temp_string,",");
                    ?>
                    ]
                    ...
                    <?php
                        $temp_string = '';
                        foreach($connection_hour_labels as $labels)
                             $temp_string .= '"'. $labels . '",';
                        echo chop($temp_string,",");
                    ?>
                   ]'></div>
            ...
            <div class="col-sm-6 col-lg-6 col-xl-3 g-mb-30">
              ...
              <div class="card h-100 g-brd-gray-light-v7 rounded">
                <div class="card-block g-pa-20">
                  <h4 class="media g-font-size-16 g-mb-10">
                  <span class="d-flex align-self-center g-font-weight-400 g-color-gray-dark-v6">Loại kết nối</span>
            ...
            <div class="col-sm-6 col-lg-6 col-xl-3 g-mb-30">
              ...
              <div class="card h-100 g-brd-gray-light-v7 rounded">
                <div class="card-block g-pa-20">
                  <h4 class="media g-font-size-16 g-mb-10">
                  <span class="d-flex align-self-center g-font-weight-400 g-color-gray-dark-v6">Thiết bị</span>
            ...
            <div class="col-xl-4">
              ...
              <div class="card g-brd-gray-light-v7 text-center g-pt-40 g-pt-60--md g-mb-30">
                <header class="g-mb-30">
                  <img class="img-fluid rounded-circle g-width-125 g-height-125 g-mb-14" src="../../assets/img-temp/200x200/img7.jpg" alt="Image description">
